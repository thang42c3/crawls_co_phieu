...
from app import db
from app.download_file import bp
from flask import Flask
from app import app
from flask import Flask, send_file, render_template
from app.model import lich_su_gia_co_phieu
from app.model import kinh_doanh_theo_quy, kinh_doanh_theo_nam, can_doi_kt_theo_quy, can_doi_kt_theo_nam, lc_theo_quy, lc_theo_nam
from app.model import lich_chia_co_tuc
from app.model import tai_san, nguon_von, tien_mat_tren_co_phieu, ket_qua_kinh_doanh_quy, co_cau_loi_nhuan, cpqh_qldn_dt, pe_eps, roa_roe
from config import config

config = config()

@bp.route('/download_file/<ma_co_phieu1>', methods = ['GET', 'POST'])
def download_file(ma_co_phieu1):
    ma_co_phieu1 = request.form.get('code_co_phieu')
    return render_template('download_file')
